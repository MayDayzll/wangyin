...
public class NimSDKOptionConfig {
   ...
   public static SDKOptions getSDKOptions(Context context) {
        ...
        // 会话置顶是否漫游
        options.notifyStickTopSession = false;
...
//        }
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        // 点击通知需要跳转到的界面
        config.notificationEntrance = MainActivity.class;// 点击通知栏跳转到该Activity、参考nim_demo
    ...
    private static MixPushConfig buildMixPushConfig() {
        ...
        // TODO: 2020/7/16 修改为加盟网在各平台的相应信息
        // 小米推送
        config.xmAppId = "2882303761517322053";
        config.xmAppKey = "5281732258053";
        config.xmCertificateName = "JmwXiaoMiPush";

        // 华为推送

        config.hwAppId = "10689203";
        config.hwCertificateName = "JmwHuaweiPush";
